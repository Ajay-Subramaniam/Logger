...
CLOUDWATCH_NAMESPACE = "EC2InstanceMetrics"
...
def generate_logs(instance_name):
    while True:
        ...
        emit_metric("TransactionsProcessed_emit_from _code", 1, instance_name)  # 1 transaction processed
        if error_count > 0:
            emit_metric("ErrorsOccurred_emit_from _code", error_count, instance_name)  # Track errors per transaction
...
if __name__ == "__main__":
    instance_name = "Instance 1"  # Change to "Instance 2" for the second EC2 instance
